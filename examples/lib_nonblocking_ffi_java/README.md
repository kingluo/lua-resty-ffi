...
(cd httpclient-demo; mvn -DskipTests=true -Dmaven.test.skip=true package)
...
```bash
CLASSPATH=$PWD:$PWD/httpclient-demo/target/httpclient-demo-1.0-SNAPSHOT-jar-with-dependencies.jar:$PWD/echo-demo/target/echo-demo-1.0-SNAPSHOT-jar-with-dependencies.jar LD_LIBRARY_PATH=/usr/lib/jvm/java-17-openjdk-amd64/lib/:/usr/lib/jvm/java-11-openjdk-amd64/lib/server:$PWD /opt/nffi/nginx/sbin/nginx -p $PWD -c nginx.conf -g "daemon off;"
